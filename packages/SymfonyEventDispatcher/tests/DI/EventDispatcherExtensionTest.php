...
use Symplify\SymfonyEventDispatcher\DI\EventDispatcherExtension;
use Symplify\SymfonyEventDispatcher\Tests\DI\EventDispatcherExtensionSource\SomeEventSubscriber;
...
final class EventDispatcherExtensionTest extends TestCase
{
    ...
    private function getExtension() : EventDispatcherExtension
    {
