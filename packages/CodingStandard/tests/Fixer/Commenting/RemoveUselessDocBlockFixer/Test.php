...
final class Test extends AbstractSimpleFixerTestCase
{
    ...
    public function provideFixCases(): array
    {
        return [
            ...
            [__DIR__ . '/fixed/fixed6.php.inc', __DIR__ . '/wrong/wrong6.php.inc'],
            [__DIR__ . '/fixed/fixed7.php.inc', __DIR__ . '/wrong/wrong7.php.inc'],
            [__DIR__ . '/fixed/fixed8.php.inc', __DIR__ . '/wrong/wrong8.php.inc'],
            [__DIR__ . '/fixed/fixed9.php.inc', __DIR__ . '/wrong/wrong9.php.inc'],
        ];
    }
