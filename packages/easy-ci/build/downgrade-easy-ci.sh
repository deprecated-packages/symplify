...
php -d memory_limit=-1 vendor/bin/rector process bin src packages vendor --config packages/easy-ci/build/config/config-downgrade.php --working-dir $BUILD_DIRECTORY --ansi
