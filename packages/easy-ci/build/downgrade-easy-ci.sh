...
# sh build/downgrade-easy-ci.sh <directory-to-downgrade>
BUILD_DIRECTORY=$1
...
php -d memory_limit=-1 vendor/bin/rector process bin config src packages vendor --config packages/easy-ci/build/config/config-downgrade.php --working-dir $BUILD_DIRECTORY --ansi
