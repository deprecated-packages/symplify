...
/**
 * @see \Symplify\CodingStandard\Tests\Fixer\Commenting\RemoveUselessConstructorCommentFixer\RemoveUselessConstructorCommentFixerTest
 */
final class RemoveUselessConstructorCommentFixer extends AbstractSymplifyFixer implements DocumentedRuleInterface
{
    /**
     ...
     * @var string
     */
    private const ERROR_MESSAGE = 'Remove useless "// <Some> constructor." comment';
