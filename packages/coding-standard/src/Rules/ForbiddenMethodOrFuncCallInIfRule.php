...
/**
 * @see \Symplify\CodingStandard\Tests\Rules\ForbiddenMethodOrFuncCallInIfRule\ForbiddenMethodOrFuncCallInIfRuleTest
 */
final class ForbiddenMethodOrFuncCallInIfRule extends AbstractSymplifyRule
{
    /**
     * @var string
     */
