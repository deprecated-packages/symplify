...
php -d memory_limit=-1 vendor/bin/rector process bin src packages vendor --config packages/monorepo-builder/build/config/config-downgrade.php --working-dir $BUILD_DIRECTORY --ansi
