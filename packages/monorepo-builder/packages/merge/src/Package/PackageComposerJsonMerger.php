...
namespace Symplify\MonorepoBuilder\Merge\Package;
...
/**
 * @deprecated Use
 * @see \Symplify\MonorepoBuilder\Merge\ComposerJsonMerger
 */
final class PackageComposerJsonMerger
{
    ...
    public function mergeFileInfos(array $composerPackageFileInfos): ComposerJson
    {
        ...
        foreach ($composerPackageFileInfos as $packageFileInfo) {
            ...
            $this->composerJsonMerger->mergeJsonToRoot($mainComposerJson, $packageComposerJson, $packageFileInfo);
        }
