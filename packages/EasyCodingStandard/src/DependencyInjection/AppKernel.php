...
use Symplify\EasyCodingStandard\DependencyInjection\CompilerPass\CustomDefinitionsCompilerPass;
...
final class AppKernel extends AbstractCliKernel
{
    ...
    protected function build(ContainerBuilder $containerBuilder): void
    {
        ...
        $containerBuilder->addCompilerPass(new CustomDefinitionsCompilerPass);
    }
}
