...
/**
 * @see \Symplify\PHPStanRules\Tests\Rules\AllowedExclusiveDependencyRule\AllowedExclusiveDependencyRuleTest
 */
final class AllowedExclusiveDependencyRule extends AbstractSymplifyRule
{
    /**
     * @var string
     */
