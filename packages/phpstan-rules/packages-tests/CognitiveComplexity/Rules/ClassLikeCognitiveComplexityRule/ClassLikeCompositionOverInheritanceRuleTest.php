...
final class ClassLikeCompositionOverInheritanceRuleTest extends RuleTestCase
{
    ...
    {
        $errorMessage = sprintf(ClassLikeCognitiveComplexityRule::ERROR_MESSAGE, 54, 30);
        yield [__DIR__ . '/Fixture/ClassWithManyComplexMethods.php', [[$errorMessage, 7]]];

        $errorMessage = sprintf(ClassLikeCognitiveComplexityRule::ERROR_MESSAGE, 34, 30);
        yield [__DIR__ . '/Fixture/SimpleCommand.php', [[$errorMessage, 9]]];

        $errorMessage = sprintf(ClassLikeCognitiveComplexityRule::ERROR_MESSAGE, 44, 30);
